...
export default function opportunity({ userFormdata }) {  // Default to empty array if not provided
    ...
    const addRow = () => {
        ...
        if (activeTab === "Opportunity Details") {
            ...
            if (dataEffort.length > 0) {
                newRow.totalEffort = dataEffort[dataEffort.length - 1].totalEffort;
            } else {
                newRow.totalEffort = 0;
            }
            ...
            setDataDocuments([...dataDocuments, rowWithKey]);
            ...
            customBodyRender: (value, tableMeta, updateValue) => {
                ...
                if (field.type === 'Text') {
                    ...
                    const rowCount = activeTab === "Opportunity Details" ? dataOpportunity.length :
                        activeTab === "Documents" ? dataDocuments.length :
    ...
    const submitformdata = async (value) => {
        ...
        const transformedData = {
            ...
            clientName: typeof inputData.clientName === 'object' && inputData.clientName !== null
                ? inputData.clientName.value
                : inputData.clientName,
            startDate: inputData.startDate,
            endDate: inputData.endDate,
            location: typeof inputData.location === 'object' && inputData.location !== null
        ...
        // Normalize file input: support several possible field names and FileList
        const rawFiles =
            value.pricingDoccument ||
            value.pricingDoccument ||   // keep old spelling if used in form
            value.documents ||
            value.documentFile ||
            [];
        ...
        try {
            ...
            if (response) {
                ...
                if (activeTab === "Effort Details") {
                    ...
                    const message = 'You have successfully Edit <strong>Opportunity</strong>!';
                    toast.success(({ id }) => (
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content={"Edit Opportunity"} />
            </Head>
            {isNotesModalOpen ? (
