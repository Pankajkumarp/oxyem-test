...
export default function adminDashboard({ }) {
    ...
    return (
        <>
            <Head>
                <title>Admin Timesheet Dashboard | Oxytal</title>
                <meta name="description" content={"Manage employee timesheets with approval status, logged hours, and detailed time tracking insights."} />
            </Head>
            <TimesheetPopup isOpen={isTimeSheetModal} closeModal={closeTimesheetpopup} isfor={""} timesheetId={timesheetId} closeAfterAction={closeAfterAction} section={"admintimesheet"} sectionName={"Employee Timesheet"} />
            ...
            <div className="main-wrapper">
                <div className="page-wrapper">
                    <div className="content container-fluid">
                        <Breadcrumbs
                            maintext={"Timesheet Review & Approval"}
                            discription={"Review, monitor, and manage employee timesheets, track logged hours, approval status, and work trends from a centralized admin dashboard."}
