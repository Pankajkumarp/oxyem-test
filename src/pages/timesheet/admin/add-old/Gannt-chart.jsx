                ...
                <div className={`gantt-left ${view === "week" ? "week-left-head" : ""}`}>
                    ...
                    {data.map((t, i) => (
                        <div key={i} className="gantt-left-row">
                            <div className="sr-no">{i + 1}</div>
                            <div className="truncate" title={t.task} data-tooltip-id={`left-task-${i}`}>{t.task}</div>
                    ...
                    {data.map((t, i) => {
                        ...
                        return (
                            <div key={i} className={`${view === "day" ? "gantt-row" : "gantt-month"}`} style={{ width: columns * COL_WIDTH }}>
                                <div className="task-bar" style={{ left, width }} data-tooltip-id={`task-${i}`}>
                                    {t.task}
                                </div>
