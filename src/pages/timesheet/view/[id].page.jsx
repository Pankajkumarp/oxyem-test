        ...
        const getProjectValue = async (id) => {
            try {
                ...
                if (response) {
                    ...
                    setViewDetail(apiResponse)
                    if (apiResponse?.taskList?.length > 0) {
                        setOpenTask(apiResponse.taskList[0].taskCode);
                    }
                }
