            ...
            if (value) {
                ...
                if (response.status === 200 && response.data.data) {
                    ...
                    opportunitySubsection.fields.forEach(field => {
                        ...
                        if (fetchedData.customerinfodata[field.name] !== undefined) {


                            field.value = fetchedData.customerinfodata[field.name];
                        }
						if (field.name === "BTP") {
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content={"Edit Invoice"} />
            </Head>
            {isNotesModalOpen ? (
                    ...
                    <div className="content container-fluid">
                        <div className="row">
                            <div className="col-12 col-lg-12 col-xl-12">
                                <div className="row">
                                    <div className="col">
                                        <Breadcrumbs maintext={"Edit Invoice"} />
                                    </div>
