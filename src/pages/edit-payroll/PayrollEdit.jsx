...
import PreviewPopupComponent from '../add-payroll/PreviewPopupComponent';
...
const deleteSavedRow = (name, index) => {
    setExtraFields(prev => {
        ...
        // 🔥 Build payload using updated data
        const payload = buildPayrollPayloadWithExtras(updatedExtras);
        submitformdata(payload);
                    ...
                    <div className="card main-card border-0 shadow-sm">
                        ...
                        <div className="row p-4 top-field-i">
                            <div className="col-md-6 top-field-add">
                                <Employee onChange={onChange} documentType={"permanent"} showImage="yes" label="Name" selectedAsset={idEmployee?.value} isDisabled={true}/>
                            </div>
                            <div className="col-md-6 top-field-add">
