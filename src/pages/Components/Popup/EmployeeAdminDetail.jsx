...
export default function EmployeeDetailsDrawer({ isOpen, closeModal, selectedFilter, activeStatus, handleClearFilter }) {
            ...
            <div className="modal-dialog modal-lg">
                <div className="modal-content">
                    <div className="modal-header mb-2">
                        <h4 className="modal-title">Employees - {Object.values(selectedFilter || {})[0]}</h4>
