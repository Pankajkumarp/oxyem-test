...
const PayrollHistroy = ({ isOpen, closeModal, isviewId, section, handleUpadateClick }) => {
  ...
  const getAttendanceDetails = async (id) => {
    try {
      const response = await axiosJWT.get(`${apiUrl}/payroll/viewSalaryHistory`, {
        params: {
          idSalary: id,
        },
      });
          ...
          <div className="modal-body">
            <div className="main-view-box-leave">
              <div className="top-box-leave">
                <h5 className="text_top_l">Payroll Histroy</h5>
                ...
                <div className="detail-box-leave" key={index}>
                  {request.generatedOn && (
                    <div className="top-box-other-text top-box-other-text-detail">
                      Generated on <span>{request.generatedOn}</span> by <span>{request.generatedBy}</span>
                    </div>
                  )}
                  {request.approvedOn && (
                    <div className="top-box-other-text top-box-other-text-detail">
