...
const ClientHistroy = ({ isOpen, closeModal, opportunityId }) => {
  ...
  const getInvoiceDetail = async (id) => {
    try {
      const response = await axiosJWT.get(`${apiUrl}/client/History`, {
        params: {
          id: id,
        },
      });
          ...
          <div className="modal-body">
            <div className="main-view-box-leave main-view-box-opportunity">
              <div className="top-box-leave">
                <h5 className="text_top_l">Client Edit Histroy</h5>
