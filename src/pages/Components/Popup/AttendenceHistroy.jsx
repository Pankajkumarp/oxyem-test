        ...
        <div className="detail-box-leave">
          ...
          {detail.actionfor === "attendance" && detail.actionBy  &&(
            <>
             ...
             {capitalizeFirstLetter(detail.status) } on {detail.actionOn} <br/>by {detail.actionBy}
              </div>
              {detail.status && (
          ...
          {detail.actionfor === "shift" && detail.actionBy && datafor === 'shift' && (
            <>
              <div className="top-box-other-text top-box-other-text-detail">
                Shift Allowance {detail.status} on {detail.actionOn}<br/> by {detail.actionBy}
