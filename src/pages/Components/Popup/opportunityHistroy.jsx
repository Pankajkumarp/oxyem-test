...
const opportunityHistroy = ({ isOpen, closeModal, opportunityId }) => {
  ...
  const getAttendanceDetails = async (id) => {
    try {
      const response = await axiosJWT.get(`${apiUrl}/opportunity/viewHistory`, {
        params: {
          id: id,
        },
      });
          ...
          <div className="modal-body">
            <div className="main-view-box-leave main-view-box-opportunity">
              <div className="top-box-leave">
                <h5 className="text_top_l">Opportunity Edit Histroy</h5>
                ...
                <div className="detail-box-leave detail-box-opportunity" key={index}>
                  {request.submittedOn && (
                    <div className="top-box-other-text top-box-other-text-detail">
                      Edit on <span>{request.submittedOn}</span> by <span>{request.submittedBy}</span>
                    </div>
                  )}
                  {request.status && (
...
export default opportunityHistroy;
