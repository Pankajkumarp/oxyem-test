            ...
            <div className="row">
              <div className="col-12 col-md-6">
                <div className="custom_padding_taskbar_box">
                  <img src="\assets\img\attendance_1.png" className='oxy_dashboard_img' />
                  <div className='oxy_tsk_inn_box win_t'>
                    <span className='oxy_tsk_1'>{statData.attendanceSubmitted}</span>
                    <span className='oxy_tsk_2'>% Attendance</span>
                  </div>
                </div>
              </div>
              <div className="col-12 col-md-6">
                <div className="custom_padding_taskbar_box">
                  <img src="\assets\img\attendance_u.png" className='oxy_dashboard_img' />
                  <div className='oxy_tsk_inn_box loss_t'>
                    <span className='oxy_tsk_1'>{statData.attendanceNotSubmitted}</span>
                    <span className='oxy_tsk_2'>Attendance</span>
                  </div>
                </div>
              </div>
              <div className="col-12 col-md-6">
                <div className="custom_padding_taskbar_box">
                  <img src="\assets\img\resource.png" className='oxy_dashboard_img' />
                  <div className='oxy_tsk_inn_box pen_t'>
                    <span className='oxy_tsk_1'>{statData.totalTtimesheetSubmitted}</span>
                    <span className='oxy_tsk_2'>T Effort</span>
                  </div>
                </div>
              </div>
              <div className="col-12 col-md-6">
                <div className="custom_padding_taskbar_box">
                  <img src="\assets\img\approve.png" className='oxy_dashboard_img' />
                  <div className='oxy_tsk_inn_box ten_t'>
                    <span className='oxy_tsk_1'>{statData.totalTimesheetsApproved}</span>
                    <span className='oxy_tsk_2'>Approved</span>
                  </div>
                </div>
              </div>
            </div>
