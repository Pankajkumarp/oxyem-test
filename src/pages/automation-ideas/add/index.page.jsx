  ...
  const fetchForm = async () => {
    ...
    const submitformdata = async (formdata) => {
        ...
        try {
              ...
              const apiUrl = process.env.NEXT_PUBLIC_API_BASE_URL + '/automationIdea/add';
    ...
    return (
        <>
        <Head><title>{pageTitles.AutomationIdeasAddIdea}</title></Head>
                ...
                <div className="page-wrapper">
                    <div className="content container-fluid">
                        <div className="page-header">
                            <div className="row">
                            <div className="col">
                            <Breadcrumbs maintext={"Add Automation Ideas"} />
                            </div>
                            </div>
                        </div>
                        <div className="row">
                                        ...
                                        <div className="card flex-fill comman-shadow oxyem-index">
                                            <div className="center-part">
                                                <div className="card-body oxyem-mobile-card-body">
                                                    <div className="col-12 col-md-12 col-xl-12 col-sm-12 mx-auto card border" id="automation-create-page">
