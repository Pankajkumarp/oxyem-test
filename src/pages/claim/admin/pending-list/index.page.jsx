...
export default function ClaimAdminPending() {
    ...
    return (
        <>
            <Head>
                <title>{pageTitles.ClaimPendingForApproval}</title>
                <meta name="description" content={pageTitles.ClaimPendingForApproval} />
            </Head>
            ...
            <div className="main-wrapper">
                <div className="page-wrapper">
                    <div className="content container-fluid">
                        ...
                        <Breadcrumbs maintext={"Pending for Approval (Claim)"} addlink={"/claim/admin/add"} />
                                                ...
                                                <div className="card-body oxyem-mobile-card-body">
                                                    <div className="col-12 col-md-12 col-xl-12 col-sm-12 mx-auto card border" id="sk-create-page">
                                                        <CustomDataTable
                                                            ...
                                                            dashboradApi={'/claims/pendingList'}
                                                        />
                                                    </div>
                                                </div>
                                            </div>
